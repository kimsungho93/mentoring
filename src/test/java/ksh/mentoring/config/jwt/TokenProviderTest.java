package ksh.mentoring.config.jwt;
...
public class TokenProviderTest {
    ...
    @DisplayName("유저 정보와 만료 기간을 전달해 토큰 생성")
    @Test
    void generateToken() {
        // given
        User user = userRepository.save(
                User.builder()
                        .email("tigertjdgh@gmail.com")
                        .password("1234")
                        .build());
    ...
    @DisplayName("유효한 토큰인 때에 유효성 검증에 성공한다.")
    @Test
    ...
    void getAuthentication() {
        // given
        String email = "tigertjdgh@gmail.com";
        String token = JwtFactory.builder()
                .subject(email)
                .build()
                .createToken(jwtProperties);
